    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          {/* DESKTOP NAVIGATION (Shifted to lg to accommodate tablets) */}
          <div className="hidden lg:flex items-center bg-gray-100/50 p-1.5 rounded-full border border-gray-200">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
          ...
          {/* ACTION SECTION: Terms + CTA (Shifted to lg to accommodate tablets) */}
        ...
        {/* MOBILE & TABLET NAVIGATION DRAWER (Visible up to lg) */}
        <div
